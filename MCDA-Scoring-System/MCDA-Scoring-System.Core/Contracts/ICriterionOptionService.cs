...
namespace MCDA_Scoring_System.MCDA_Scoring_System.Core.Contracts
{
    ...
    {
        public Task<IEnumerable<CriterionOptionDto>> CreateCriterionOptionAsync(CreateCriterionOptionsDto dto);
        ...
        public Task UpdateCriterionOptionAsync(int id, UpdateCriterionOptionsDto dto);
